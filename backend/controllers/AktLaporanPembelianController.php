 ...
 */
class AktLaporanPembelianController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    public function actionLaporanPembelianCetak($tanggal_awal, $tanggal_akhir)
    {
        return $this->renderPartial('laporan_pembelian_cetak', [
            'tanggal_awal' => $tanggal_awal,
            'tanggal_akhir' => $tanggal_akhir,
        ]);
    }

    public function actionLaporanPembelianExcel($tanggal_awal, $tanggal_akhir)
    {
        return $this->renderPartial('laporan_pembelian_excel', [
            'tanggal_awal' => $tanggal_awal,
            'tanggal_akhir' => $tanggal_akhir,
        ]);
    }
