...
<table class="table1">
    <thead>
        ...
        <tr>
            ...
            <th class="header_kiri">: <?= tanggal_indo($model->tanggal_pembelian) ?></th>
        </tr>
        <tr>
            ...
            ?>
                ...
                <th class="header_kiri">: <?= !empty($model->tanggal_faktur_pembelian) ?  tanggal_indo($model->tanggal_faktur_pembelian) : "" ?></th>
            <?php
...
<table class="table3" border="0">
    <thead>
        <tr>
            ...
            <th>DPP</th>
            <th><?= ribuan($total_pembelian_barang) ?></th>
        </tr>
        <tr>
            ...
            <th>
                <?php
                $diskon = ($model->diskon > 0) ? ($total_pembelian_barang * $model->diskon) / 100 : 0;
                echo ribuan($diskon);
                ?>
            </th>
        </tr>
        <tr>
            ...
            <th>
                <?php
                $pajak = ($model->pajak > 0) ? $pajak = (($total_pembelian_barang - $diskon) * 10) / 100 : 0;
                echo ribuan($pajak);
                ?>
            </th>
        </tr>
