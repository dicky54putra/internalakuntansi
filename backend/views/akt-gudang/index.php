...
/* @var $searchModel backend\models\AktGudangSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Gudang';
// $this->params['breadcrumbs'][] = $this->title;
?>
<div class="akt-gudang-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = 'index.php?r=akt-gudang/view&id=' . $model->id_gudang;
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = 'index.php?r=akt-gudang/update&id=' . $model->id_gudang;
                        return $url;
                    }

                    if ($action === 'delete') {
                        $url = 'index.php?r=akt-gudang/delete&id=' . $model->id_gudang;
                        return $url;
                    }
                }
            ],
        ...
        'panel' => [
            ...
            'heading' => '<span class="fa fa-home"></span> Gudang',
        ],
        'persistResize' => false,
