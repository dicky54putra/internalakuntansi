...
/* @var $searchModel backend\models\AktPenyesuaianStokSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Data Penyesuaian Stok';
// $this->params['breadcrumbs'][] = $this->title;
?>
<div class="akt-penyesuaian-stok-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = 'index.php?r=akt-penyesuaian-stok/view&id=' . $model->id_penyesuaian_stok;
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = 'index.php?r=akt-penyesuaian-stok/update&id=' . $model->id_penyesuaian_stok;
                        return $url;
                    }

                    if ($action === 'delete') {
                        $url = 'index.php?r=akt-penyesuaian-stok/delete&id=' . $model->id_penyesuaian_stok;
                        return $url;
                    }
                }
            ],
        ...
        'panel' => [
            ...
            'heading' => '<span class="glyphicon glyphicon-th-large"></span> ' . $this->title,
        ],
        'persistResize' => false,
