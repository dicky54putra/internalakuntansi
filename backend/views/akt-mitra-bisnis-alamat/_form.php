        ...
        <div class="panel-body">
            <div class="col-md-12" style="padding: 0;">
                        ...
                        <div class="col-md-6">
                            ...
                            <?=
                                $form->field($model, 'id_kota')->widget(Select2::classname(), [
                                    'data' =>  $model->isNewRecord ? '' :  ArrayHelper::map(AktKota::find()->all(), 'id_kota', function ($model_kota) {
                                        return $model_kota->kode_kota . ' - ' . $model_kota->nama_kota;
                                    }),
                                    'language' => 'en',
                ...
                if (window.location.href.indexOf("update") < 1) {
                    callback('#aktmitrabisnisalamat-id_kota', 'akt-kota/get-kota&sort=0');
                } else {
                    setKode();
                }
                ...
                async function setKode () {
                    ...
                    function submitKota(e) {
                        ...
                        const params = {
                            ...
                            "idSelect" :'#aktmitrabisnisalamat-id_kota',
                            "idNama" : "#nama_kota",
