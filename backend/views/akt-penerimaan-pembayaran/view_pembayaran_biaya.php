                                ...
                                'attributes' => [
                                    ...
                                    [
                                        ...
                                        'value' => function ($model) {
                                            $query = (new \yii\db\Query())->from('akt_pembayaran_biaya')->where(['id_pembelian' => $model->id_pembelian]);
                                            $sum_nominal = $query->sum('nominal');
                                            $sisa = $model->total - $sum_nominal;
                                            $sisa2 = $sum_nominal - $model->total;
                                            if ($model->total >= $sum_nominal) {
                                                # code...
                                                return ribuan($sisa);
                                            } else {
                                                # code...
                                                return 'Kelebihan : ' . ribuan($sisa2);
                                            }
                                        }
                                    ],
                                ],
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?= Html::a('<span class="glyphicon glyphicon-edit"></span>', ['akt-pembayaran-biaya/update-from-view', 'id' => $data['id_pembayaran_biaya']], ['class' => 'btn btn-primary']) ?>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <?= $form->field($model_pembayaran_biaya, 'id_kas_bank')->widget(Select2::classname(), [
                                                    'data' => $data_kas_bank,
                                                    'language' => 'en',
