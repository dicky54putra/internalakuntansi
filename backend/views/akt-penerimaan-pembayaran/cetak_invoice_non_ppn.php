        ...
        ?>
            <tr>
                ...
                <td style="text-align: right;">
                    ...
                    $harga_plus_ppn = $harga_asli + ($harga_asli * 0.1);
                    $total_penjualan_per_item = $harga_plus_ppn * $data['qty'];
                    $dpp += $total_penjualan_per_item;
                    ?>
                    <?= ribuan($harga_plus_ppn) ?>
                </td>
                ...
                <td style="text-align: right;">
                    <?php if ($data['jenis_diskon'] == 1) { ?>
                        <?php
                        $hasil_diskon = $harga_plus_ppn - (($harga_plus_ppn * $data['diskon']) / 100);
                    ...
                    <?php } else if ($data['jenis_diskon'] == 2) { ?>
                        ...
                        <?php
                        #1
                        $diskonBertingkat = $harga_plus_ppn - (($harga_plus_ppn * $data['diskon']) / 100);
                ...
                <td style="text-align: right;">
                    <?= ribuan($total_penjualan_per_item) ?>
                </td>
            </tr>
        <?php } ?>
    </tbody>
...
<table class="table3" border="0">
    <thead>
        ...
        <?php if (!empty($sum_retur)) { ?>
            <tr>
                <th colspan="4"></th>
                <th style="text-align: left;">Total Retur</th>
        ...
        <tr>
            ...
            <th style="text-align: center; font-size: 15px;"></th>
            <th style="font-weight: bold; font-size: 15px;text-align: left;">Tagihan</th>
            <?php $grandtotal = $dpp + $model->ongkir - ($diskon + $sum_retur + $retValUangMuka = ($model->uang_muka > 0) ? $model->uang_muka : 0) ?>
