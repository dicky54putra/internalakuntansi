...
<div class="akt-stok-masuk-detail-form">
                ...
                <div class="box-body">
                    ...
                    <?php $form = ActiveForm::begin(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <?= Html::a('<span class="glyphicon glyphicon-circle-arrow-left"></span> Kembali', ['akt-stok-masuk/view', 'id' => $model->id_stok_masuk], ['class' => 'btn btn-warning']) ?>
                        </div>
