...
<?php
$query_stok_masuk = AktStokMasuk::find()->where(["BETWEEN", "tanggal_masuk", $tanggal_awal, $tanggal_akhir])->orderBy("nomor_transaksi ASC")->asArray()->all();
    ...
    <table class="tabel">
        <thead>
            <tr>
                ...
                <th style="width: 1%;">:</th>
                <td style="width: 20%;"><?= tanggal_indo($data['tanggal_masuk'], true) ?></td>
                <th style="width: 5%;">Tipe</th>
                <th style="width: 1%;">:</th>
                <td style="width: 15%;"><?= ($data['tipe'] == 1) ? 'Barang Masuk' : '' ?></td>
