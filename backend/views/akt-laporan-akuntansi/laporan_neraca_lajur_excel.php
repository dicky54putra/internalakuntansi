...
<table class="table table-condensed table-bordered table-hover" style="font-size: 15px;">
    <!-- <thead> -->
    <tr>
        ...
        <th rowspan="2" style="vertical-align: middle;text-align: center;max-width: 50px;">Nama Akun</th>
    ...
    <tr>
        <th style="text-align: center;min-width: 100px;">Debit</th>
        <th style="text-align: center;min-width: 100px;">Kredit</th>
        <th style="text-align: center;min-width: 100px;">Debit</th>
        <th style="text-align: center;min-width: 100px;">Kredit</th>
        <th style="text-align: center;min-width: 100px;">Debit</th>
        <th style="text-align: center;min-width: 100px;">Kredit</th>
...
<?php
$fileName = "Laporan Neraca Lajur.xls";
