...
<div style="margin: 30px;">
    ...
    <div style="page-break-after: always;">
        ...
        <table class="table2">
            ...
            <tbody>
                <tr>
                    <th colspan="5">Daftar PPN Masukan</th>
                </tr>
                <?php
                $gt = 0;
                ...
                <tr>
                    <th colspan="5">Daftar PPN Keluaran</th>
                </tr>
                <?php
                $gt_ = 0;
                ...
                <tr>
                    <th style="text-align: right;" colspan="4">Jumlah Kurang Bayar</th>
...
<?php
$fileName = "Laporan Rekonsiliasi PPN.xls";
