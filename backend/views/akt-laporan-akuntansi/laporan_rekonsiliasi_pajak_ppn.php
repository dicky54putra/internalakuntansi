...
$this->title = 'Laporan Rekonsiliasi Pajak PPN';
?>
                    ...
                    <div class="col-md-12" style="padding: 0;">
                        <div class="box-body">
                            ...
                            <table class="table">
                                ...
                                <tfoot>
                                    <tr>
                                        <th colspan="6" style="text-align: right;">Jumlah Daftar PPN Masukan</th>
                    ...
                    <div class="col-md-12" style="padding: 0;">
                        <div class="box-body">
                            ...
                            <table class="table">
                                ...
                                <tfoot>
                                    <tr>
                                        <th colspan="6" style="text-align: right;">Jumlah Daftar PPN Keluaran</th>
                                        <th style="text-align: right;">0</th>
                                    </tr>
                                </tfoot>
                            </table>
                    ...
                    <div class="col-md-12" style="padding: 0;">
                        <div class="box-body">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th style="text-align: right;">Jumlah Kuran Bayar</th>
                                        <th style="text-align: right;width: 15%;">0</th>
                                    </tr>
                                </thead>
                            </table>
