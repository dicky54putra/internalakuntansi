...
<table class="table1">
    <thead>
        ...
        <tr>
            ...
            <th class="header_kiri">: <?= date('d/m/Y', strtotime($model->tanggal_pembelian)) . ' ' . date('H:i') ?></th>
        ...
        <tr>
            ...
            ?>
                ...
                <th class="header_kiri">: <?= date('d/m/Y', strtotime($model->tanggal_faktur_pembelian)) ?></th>
            <?php
