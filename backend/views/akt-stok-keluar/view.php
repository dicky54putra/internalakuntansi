...
$this->title = 'Detail Data Stok Keluar : ' . $model->nomor_transaksi;
// $this->params['breadcrumbs'][] = ['label' => 'Akt Stok Keluars', 'url' => ['index']];
// $this->params['breadcrumbs'][] = $this->title;
\yii\web\YiiAsset::register($this);
?>
<div class="akt-stok-keluar-view">
    ...
    <p>
        ...
        <?= Html::a('<span class="glyphicon glyphicon-edit"></span> Ubah', ['update', 'id' => $model->id_stok_keluar], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('<span class="glyphicon glyphicon-trash"></span> Hapus', ['delete', 'id' => $model->id_stok_keluar], [
                ...
                <div class="box-body">
                        ...
                        'attributes' => [
                            ...
                            [
                                ...
                                'value' => function ($model) {
                                    return tanggal_indo($model->tanggal_keluar, true);
                                }
                            ],
                            [
                                'attribute' => 'tipe',
                    ...
                    <div class="row">
                        <div class="box-body">
                            <?php $form = ActiveForm::begin([
                                'method' => 'post',
                                'action' => ['akt-stok-keluar-detail/create', 'id' => $model->id_stok_keluar],
                            ]); ?>
                    ...
                    <table class="table" style="margin-left:7px;">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $query_detail = AktStokKeluarDetail::find()->where(['id_stok_keluar' => $model->id_stok_keluar])->all();
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php // Html::a('<span class="glyphicon glyphicon-edit"></span>', ['akt-stok-keluar-detail/update', 'id' => $data['id_stok_keluar_detail']], ['class' => 'btn btn-primary']) 
                                        ?>
                                        <?= Html::a('<span class="glyphicon glyphicon-trash"></span>', ['akt-stok-keluar-detail/delete', 'id' => $data['id_stok_keluar_detail']], [
                                            'class' => 'btn btn-danger',
                                            'data' => [
                                                'confirm' => 'Are you sure you want to delete this item?',
                                                'method' => 'post',
