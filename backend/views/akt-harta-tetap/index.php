    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute' => 'tipe',
                'format' => 'html',
                'filter' => array(1 => 'Berwujud', 2 => 'Tidak Berwujud'),
                'value' => function ($model) {
                    if ($model->tipe == 1) {
                        return 'Berwujud';
                    } else {
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = 'index.php?r=akt-harta-tetap/view&id=' . $model->id_harta_tetap;
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = 'index.php?r=akt-harta-tetap/update&id=' . $model->id_harta_tetap;
                        return $url;
                    }

                    if ($action === 'delete') {
                        $url = 'index.php?r=akt-harta-tetap/delete&id=' . $model->id_harta_tetap;
                        return $url;
                    }
                }
            ],
