...
<div class="akt-penawaran-penjualan-detail-form">
        ...
        <div class="panel-body">
            <div class="col-md-12" style="padding: 0;">
                <div class="box-body">
                    ...
                    <?= $form->field($model, 'id_penawaran_penjualan')->textInput(['type' => 'hidden'])->label(false) ?>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <?= $form->field($model, 'qty')->textInput(["placeholder" => "Qty", "id" => "qty"]) ?>

                            <?= $form->field($model, 'harga')->textInput(["placeholder" => "Harga", "id" => "harga"]) ?>

                        </div>
                        <div class="col-md-6">

                            <?= $form->field($model, 'diskon')->textInput(["placeholder" => "Diskon %", "id" => "diskon"]) ?>
                    ...
                    <div class="form-group">
                        <?= Html::a('<span class="glyphicon glyphicon-circle-arrow-left"></span> Kembali', ['akt-penawaran-penjualan/view', 'id' => $model->id_penawaran_penjualan], ['class' => 'btn btn-warning']) ?>
