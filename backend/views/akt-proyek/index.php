...
/* @var $searchModel backend\models\AktProyekSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Proyek';
?>
<div class="akt-proyek-index">
...
<h1><?= Html::encode($this->title) ?></h1>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = 'index.php?r=akt-proyek/view&id=' . $model->id_proyek;
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = 'index.php?r=akt-proyek/update&id=' . $model->id_proyek;
                        return $url;
                    }

                    if ($action === 'delete') {
                        $url = 'index.php?r=akt-proyek/delete&id=' . $model->id_proyek;
                        return $url;
                    }
                }
            ],
        ...
        'panel' => [
            ...
            'heading' => '<span class="fa fa-gavel"></span> Proyek',
        ],
        'persistResize' => false,
