...
<div class="akt-pembelian-form">
    <div class="panel panel-primary">
        <div class="panel-heading"><span class="glyphicon glyphicon-shopping-cart"></span> Data Order Pembelian</div>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <?= $form->field($model, 'no_order_pembelian')->textInput(['readonly' => true]) ?>

                            </div>
                            <div class="form-group">
                                <?php

                                if ($model->tanggal_order_pembelian == '0000-00-00' || $model->tanggal_order_pembelian == '') {
                                    $model->tanggal_order_pembelian = Yii::$app->formatter->asDate('now', 'php:Y-m-d');
                                }

                                ?>

                                <?= $form->field($model, 'tanggal_order_pembelian')->widget(\yii\jui\DatePicker::classname(), [
                                    'clientOptions' => [
                                        'changeMonth' => true,
                                        'changeYear' => true,
                                    ],
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                if ($model->isNewRecord) {
                                    # code...
                                ?>
                                    <?= $form->field($model, 'status')->dropDownList(array(1 => "Order Pembelian")) ?>
                                <?php
                                } else {
                                    # code...
                                ?>
                                    <?= $form->field($model, 'status')->dropDownList(array(1 => "Order Pembelian", 2 => "Pembelian")) ?>
                                <?php
                                }
                    ...
                    <div class="form-group">
                        ...
                        if ($model->isNewRecord) {
                            ...
                            # code...
                            $url = ['view', 'id' => $model->id_pembelian];
                        }
