...
/* @var $searchModel backend\models\AktStokOpnameSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Data Stok Opname';
// $this->params['breadcrumbs'][] = $this->title;
?>
<div class="akt-stok-opname-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = 'index.php?r=akt-stok-opname/view&id=' . $model->id_stok_opname;
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = 'index.php?r=akt-stok-opname/update&id=' . $model->id_stok_opname;
                        return $url;
                    }

                    if ($action === 'delete') {
                        $url = 'index.php?r=akt-stok-opname/delete&id=' . $model->id_stok_opname;
                        return $url;
                    }
                }
            ],
        ...
        'panel' => [
            ...
            'heading' => '<span class="fa fa-cubes"></span> ' . $this->title,
        ],
        'persistResize' => false,
