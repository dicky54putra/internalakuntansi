...
/* @var $searchModel backend\models\AktCabangSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Cabang';
?>
<div class="akt-cabang-index">
...
<h1><?= Html::encode($this->title) ?></h1>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = 'index.php?r=akt-cabang/view&id=' . $model->id_cabang;
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = 'index.php?r=akt-cabang/update&id=' . $model->id_cabang;
                        return $url;
                    }

                    if ($action === 'delete') {
                        $url = 'index.php?r=akt-cabang/delete&id=' . $model->id_cabang;
                        return $url;
                    }
                }
            ],
        ...
        'panel' => [
            ...
            'heading' => '<span class="fa fa-flag-checkered"></span> Daftar Cabang',
        ],
        'persistResize' => false,
