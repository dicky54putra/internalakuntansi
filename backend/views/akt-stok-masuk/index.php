...
/* @var $searchModel backend\models\AktStokMasukSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Data Stok Masuk';
// $this->params['breadcrumbs'][] = $this->title;
?>
<div class="akt-stok-masuk-index">
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = 'index.php?r=akt-stok-masuk/view&id=' . $model->id_stok_masuk;
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = 'index.php?r=akt-stok-masuk/update&id=' . $model->id_stok_masuk;
                        return $url;
                    }

                    if ($action === 'delete') {
                        $url = 'index.php?r=akt-stok-masuk/delete&id=' . $model->id_stok_masuk;
                        return $url;
                    }
                }
            ],
