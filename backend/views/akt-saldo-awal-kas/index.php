...
/* @var $searchModel backend\models\AktSaldoAwalKasSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Saldo Awal Kas';
// $this->params['breadcrumbs'][] = $this->title;
?>
<div class="akt-saldo-awal-kas-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = 'index.php?r=akt-saldo-awal-kas/view&id=' . $model->id_saldo_awal_kas;
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = 'index.php?r=akt-saldo-awal-kas/update&id=' . $model->id_saldo_awal_kas;
                        return $url;
                    }

                    if ($action === 'delete') {
                        $url = 'index.php?r=akt-saldo-awal-kas/delete&id=' . $model->id_saldo_awal_kas;
                        return $url;
                    }
                }
            ],
        ...
        'panel' => [
            ...
            'heading' => '<span class="fa fa-bank"></span> ' . $this->title,
        ],
        'persistResize' => false,
