...
/* @var $searchModel backend\models\AktJenisApproverSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Jenis Approver';
?>
<div class="akt-jenis-approver-index">
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = 'index.php?r=akt-jenis-approver/view&id=' . $model->id_jenis_approver;
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = 'index.php?r=akt-jenis-approver/update&id=' . $model->id_jenis_approver;
                        return $url;
                    }

                    if ($action === 'delete') {
                        $url = 'index.php?r=akt-jenis-approver/delete&id=' . $model->id_jenis_approver;
                        return $url;
                    }
                }
            ],
