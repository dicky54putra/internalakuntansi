...
/* @var $searchModel backend\models\AktSaldoAwalAkunSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Daftar Saldo Awal Akun';
?>
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = 'index.php?r=akt-saldo-awal-akun/view&id=' . $model->id_saldo_awal_akun;
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = 'index.php?r=akt-saldo-awal-akun/update&id=' . $model->id_saldo_awal_akun;
                        return $url;
                    }

                    if ($action === 'delete') {
                        $url = 'index.php?r=akt-saldo-awal-akun/delete&id=' . $model->id_saldo_awal_akun;
                        return $url;
                    }
                }
            ],
