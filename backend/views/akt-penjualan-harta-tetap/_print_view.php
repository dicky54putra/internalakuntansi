    ...
    <thead>
        ...
        <tr>
            ...
            ?>
                ...
                <th class="header_kiri">: <?= date('d/m/Y', strtotime($model->tanggal_tempo))
                                            ?></th>
            <?php
    ...
    <tbody>
        ...
        ?>
            <tr>
                <td><?= $no++ . '.'
                    ?></td>
                <td><?= (!empty($satuan->nama_satuan)) ? $data['qty'] . ' ' . $satuan->nama_satuan : $data['qty']
                    ?></td>
                ...
                <td style="text-align: right;"><?php
                                                if ($data['diskon'] > 0) {
                                                    $diskon = ($data['harga'] * $data['qty']) * $data['diskon'] / 100;
                                                    $total = $data['harga'] * $data['qty'] - $diskon;
                                                    echo ribuan($total);
                                                }
                                                ?></td>
            </tr>
...
<table class="table3" border="0">
    ...
    <thead>
        ...
        <tr>
            ...
            <th style="font-weight: bold; font-size: 15px;"><?= ribuan($tagihan)
                                                            ?></th>
        </tr>
    </thead>
</table>