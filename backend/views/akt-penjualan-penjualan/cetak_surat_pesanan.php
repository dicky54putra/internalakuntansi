...
<table class="table3">
    <thead>
        ...
        <tr>
            ...
            <th style="text-align: left;width: 15%;white-space: nowrap;">: <?= !empty($model->tanggal_penjualan) ? tanggal_indo($model->tanggal_penjualan) : null ?></th>
        </tr>
        <tr>
            <th style="text-align: right;">No. PO</th>
            <th style="text-align: left;width: 15%;white-space: nowrap;">: <?= $model->no_penjualan ?></th>
        </tr>
    </thead>
</table>
<table class="table2">
