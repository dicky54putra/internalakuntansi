...
$this->title = 'Ubah Barang Penyesuaian Stok';
// $this->params['breadcrumbs'][] = ['label' => 'Akt Penyesuaian Stok Details', 'url' => ['index']];
// $this->params['breadcrumbs'][] = ['label' => $model->id_penyesuaian_stok_detail, 'url' => ['view', 'id' => $model->id_penyesuaian_stok_detail]];
// $this->params['breadcrumbs'][] = 'Update';
?>
<div class="akt-penyesuaian-stok-detail-update">
