...
$this->title = 'Daftar Jurnal Penyesuaian';
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view') {
                        $url = 'index.php?r=akt-jurnal-umum-penyesuaian/view&id=' . $model->id_jurnal_umum;
                        return $url;
                    }

                    if ($action === 'update') {
                        $url = 'index.php?r=akt-jurnal-umum-penyesuaian/update&id=' . $model->id_jurnal_umum;
                        return $url;
                    }

                    if ($action === 'delete') {
                        $url = 'index.php?r=akt-jurnal-umum-penyesuaian/delete&id=' . $model->id_jurnal_umum;
                        return $url;
                    }
                }
            ],
