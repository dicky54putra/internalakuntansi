...
class AktPembelianHartaTetapDetail extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id_pembelian_harta_tetap', 'qty', 'total', 'umur_ekonomis'], 'integer'],
            [['keterangan'], 'string'],
            [['residu', 'tipe_harta_tetap', 'tanggal_pakai', 'lokasi', 'id_kelompok_aset_tetap', 'terhitung_tanggal', 'tanggal_terjual', 'diskon'], 'safe'],
